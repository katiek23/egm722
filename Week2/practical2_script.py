...
townstatus = towns.loc[towns['STATUS'] == 'Town']
town_handle = ax.plot(townstatus.geometry.x, townstatus.geometry.y, 's', color='0.5', ms=6, transform=myCRS)
citystatus = towns.loc[towns['STATUS'] == 'City']
city_handle = ax.plot(citystatus.geometry.x, citystatus.geometry.y, 'o', color='r', ms=6, transform=myCRS)
